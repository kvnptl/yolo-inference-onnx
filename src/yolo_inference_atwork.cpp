...
Mat post_process(Mat &input_image, vector<Mat> &outputs, const vector<string> &class_name)
{
    ...
    const int dimensions = class_name.size() + 5.0;
...
{
    // Image file
    string imageFile = "../images/atwork_01.jpg";

    // Class names file
    string classFile = "../config/ss22_competition.names";
